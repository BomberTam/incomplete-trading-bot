...
limitOrderMargin = 0.5 # percentage that defines the offset for the limit orders

# YOUR API KEYS AT ALPACA GO HERE!
API_KEY = "PKB64ZGSXDWF74TE6UDF"
API_SECRET_KEY = "HkZwopH54z2e8Hq2Eex78yKiglAsDHZKFwfjPwXs"
